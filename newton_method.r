# Newton method (TWO WAYS)

# PART 1: from Prof. Manrique
...
while (abs(alpha.1-alpha.0) > eps & (i.iter < 100)){
    ...
    if (sign(fun.1(alpha.0)) == sign(fun.1(alpha.1))){
        print("find new initial interval");
        break}
    
    mid.alpha <- 0.5*(alpha.0 + alpha.1)
